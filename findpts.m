function [tm,im] = findpts(tr,pi)
%FINDPTS find the tree-to-point mappings.
%   [TM,IM] = FINDPTS(TR,PI) returns the tree-to-point and 
%   point-to-tree mappings for a given aabb-tree TR and a 
%   collection of query points PI.
%
...
%   the item IM.II(JJ).
%
%   See also FINDBOX, FINDRAY, MAKETREE
